...
file = open('D:/伴鱼/KnowledgeGraph/poem/yongwu_poem_url.txt', 'w')
for h in hyperlink:
    hh = h.get('href')
...
# 请求地址
# 咏物诗网址
f=open('D:/伴鱼/KnowledgeGraph/poem/yongwu_poem_url.txt', 'r')
for line in f:
    #print(line)
    ...
    #print(dynasty)
    f = open('D:/伴鱼/KnowledgeGraph/poem/yongwu_poem.txt','a',encoding='utf-8')
    f.write(title)
    f.write('\t')
